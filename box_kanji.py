...
def generate_image(character: str, font_file: str, background_image: Optional[Image.Image]):
...
if __name__ == '__main__':
    ...
    images = [[sample(j == 1) for i in range(5)] for j in range(2)]
...
class Kanji(IterableDataset):
    def __init__(self, fonts_folder: str, background_image_folder: str, transform):
