...
from recognizer.data.character_sets import kanji
from recognizer.recognizer.model import KanjiRecognizer
...
def run(args):
    ...
    trainset = RecognizerTrainingDataset(args.fonts_folder, args.background_images_folder,
                                         ...
                                         side_text_ratio=args.side_text_ratio, character_set=characters,
...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--backgrounds-folder", type=str, default="data/backgrounds",
                        help="path to a folder containing background images (default: data/backgrounds)")
